...
namespace RevitProjectSearch.App.UserControls.Models
{
    public class SearchItem
    {
        ...
        public SearchItem(Element itemElement, string itemName, string itemIcon, string itemDescription, string itemSearchTags, string itemGroup, int itemSortingOrder)
        {
